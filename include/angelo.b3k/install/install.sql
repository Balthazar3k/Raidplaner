INSERT INTO `ic1_config` (`schl`, `typ`, `kat`, `frage`, `wert`, `pos`) VALUES
('currency', 'input', 'Shop', 'Welche Währung', '&euro;', 0);

INSERT INTO `ic1_modules` (`url`, `name`, `gshow`, `ashow`, `fright`) VALUES
('shop', 'Shop', 1, 1, 1),
('shop-category', 'Shop - Category', 1, 1, 1),
('shop-article', 'Shop - Artikel', 1, 1, 1);

CREATE TABLE IF NOT EXISTS `ic1_shop_articles` (
...
CREATE TABLE IF NOT EXISTS `ic1_shop_category` (
...
CREATE TABLE IF NOT EXISTS `ic1_shop_units` (
...
CREATE TABLE IF NOT EXISTS `ic1_shop_address` (
...
CREATE TABLE IF NOT EXISTS `ic1_shop_order` (
...
CREATE TABLE IF NOT EXISTS `ic1_shop_order_article` (
...
INSERT INTO `ic1_shop_units` (`unit_id`, `unit_short`, `unit_unit`, `unit_text`) VALUES
